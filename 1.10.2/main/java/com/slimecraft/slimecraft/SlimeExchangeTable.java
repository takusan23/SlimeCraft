...
public class SlimeExchangeTable extends Block {
	...
	{
		playerIn.addStat(slimecraft.SlimeExchangeTable);

         if (heldItem != null && (heldItem.getItem() == Items.GUNPOWDER))
         {
             if (heldItem.stackSize >= 2)
             {
            	 heldItem.stackSize--;heldItem.stackSize--;
            	 playerIn.dropItem(new ItemStack(Items.GLOWSTONE_DUST), true);
             }
         }
